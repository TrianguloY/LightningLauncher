    ...
    private boolean updatePositions() {
        ...
        if (mAnimate) {
            ...
            if (mFloatViewMid < slideEdgeTop) {
                ...
                if (mDragState == DRAGGING && mDragListener != null)
                    mDragListener.onItemHovered(itemPos + (itemPos > mSrcPos ? 0 : -1));
            } else if (mFloatViewMid < slideEdgeBottom) {
                mFirstExpPos = itemPos;
                mSecondExpPos = itemPos;
                if (mDragState == DRAGGING && mDragListener != null)
                    mDragListener.onItemHovered(-1);
            } else {
                mFirstExpPos = itemPos;
                ...
                // "firstExp="+mFirstExpPos+" secExp="+mSecondExpPos+" slideFrac="+mSlideFrac);
                if (mDragState == DRAGGING && mDragListener != null)
                    mDragListener.onItemHovered(itemPos + (itemPos >= mSrcPos ? 1 : 0));
            }
...
//        }
    ...
    public interface DragListener {
        ...
        void onItemHovered(int position);
    }
