...
public class FolderView extends FrameLayout {
    ...
    private final BoxLayout mOuterContainer;
    private final TextView mEmptyMsg;
    private final TextView mTitle;
    private final View mSeparator;
    private final ItemLayout mItemLayout;
    ...
    private void setLayoutParams() {
        ...
        switch (ah) {
            ...
            case RIGHT:
                ...
                break;
            case CUSTOM:
                lp.leftMargin = mEditMode ? 0 : mFolderConfig.wX;
                break;
        }
        switch (av) {
            case TOP:
            ...
            case BOTTOM:
                ...
                break;
            case CUSTOM:
                lp.topMargin = mEditMode ? 0 : mFolderConfig.wY;
                break;
        }
        lp.gravity = gravity;
